/**
 * PassWordCreator -program to demonstrate use of a TextField and a GridPane.
 * @author          Ratna Lama / Luliia Oblasova / Huan Nguyen
 * @version         1.0
 * @since           09/25/2017
 */
...
public class PassWordPane extends GridPane{
    ...
    */
    public PassWordPane(){
        ...
        result = new Label("Enter info to generate password:");
        result.setFont(font);
